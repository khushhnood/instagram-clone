...
function CreatePostGit() {
    ...
    const handleSubmitFile = (e) => {
        ...
        reader.onloadend = async() => {
            ...
            if(uploaded){
                ...
                savePost(caption,imgurl,publicId);
                toast.dismiss();
                upsucess();
    ...
    const savePost = async(caption,url,publicId) =>{
           try {
               const saved = await axios.post('/post/createpost',{
                   caption : caption,
                   photo : url,
                   publicId : publicId
               },{
    ...
    const upsucess = ()=> toast.success('post added!');
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmitFile}>
                     <div className="form-group">
                               <label >Caption</label>
                                  <input  type="text"  value={caption} onChange={e=>setCaption(e.target.value)} className="form-control" id="caption" required />
